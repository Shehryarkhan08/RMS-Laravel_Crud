    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="addmeal">
                    <a href="{{route('addmeal')}}" class="btn btn-primary">Add Meal</a><br><br>
                </div>
                        ...
                        <tbody>
                            @foreach($mealdata as $cust)
                                <tr>
                                    ...
                                    <td>{{$cust->price}}</td>
                                    <td>
                                        <a href="{{ route('editmeal', ['meal_id' => $cust->meal_id]) }}" class="btn btn-primary">Edit</a>
                                        <a href="{{ route('deletemeal', ['meal_id' => $cust->meal_id]) }}" class="btn btn-danger">Delete</a> 
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
